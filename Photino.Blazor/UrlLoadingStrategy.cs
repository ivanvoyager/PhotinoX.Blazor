...
/// <summary>
/// URL loading strategy for anchor tags within a Blazor WebView.
///
/// Anchor tags with target="_blank" will always open in the default browser
/// and the UrlLoading event won't be called.
/// </summary>
public enum UrlLoadingStrategy
{
    ...
    /// This is the default strategy for URLs within the application base URI.
    /// <para>
